...
public class Singletons {
    ...
    private static CoronaApi coronaApiInstance;
    ...
    public static CoronaApi getCoronaApi(){
        if (coronaApiInstance == null){
            ...
            coronaApiInstance = retrofit.create(CoronaApi.class);
    ...
    public static SharedPreferences getsharedPreferencesInstance(Context context){
        if (sharedPreferencesInstance == null){
            sharedPreferencesInstance = context.getSharedPreferences("Coronapp", context.MODE_PRIVATE);
        }
